...
============================
This F5 Contributed DevOps package automatically configures the BIG-IP's hostname, NTP servers and time zone, DNS servers and search domain, and syslog servers. It also enables resetting the BIG-IP to factory defaults.

v2.0
Release notes:
===============
·         Initial release.
·         Supports setting and resetting of one BIG-IP.
·         Must be deployed to a BIG-IP that is being configured or reset.
